...
class TestSimbolos():
  ...
  def test_simbolos(self):
    ...
    self.driver.find_element(By.ID, "nombre").send_keys("\"#$%&")
    self.driver.find_element(By.ID, "apellido").send_keys("#$%&/(")
    self.driver.find_element(By.ID, "email").send_keys("$/3133.com")
    self.driver.find_element(By.ID, "password").send_keys("asdasdasd")
    self.driver.find_element(By.ID, "repetir").send_keys("asdasdasd")
    self.driver.find_element(By.ID, "fecha_nacimiento").click()
    self.driver.find_element(By.ID, "fecha_nacimiento").click()
    self.driver.find_element(By.ID, "fecha_nacimiento").send_keys("2024-05-15")
